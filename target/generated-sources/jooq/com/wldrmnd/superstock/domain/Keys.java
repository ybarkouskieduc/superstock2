...
public class Keys {
    ...
    public static final ForeignKey<BankExchangeTransactionRecord, UserRecord> BANK_EXCHANGE_TRANSACTION_IBFK_1 = Internal.createForeignKey(BankExchangeTransaction.BANK_EXCHANGE_TRANSACTION, DSL.name("bank_exchange_transaction_ibfk_1"), new TableField[] { BankExchangeTransaction.BANK_EXCHANGE_TRANSACTION.USER_ID }, Keys.KEY_USER_PRIMARY, new TableField[] { User.USER.ID }, true);
    public static final ForeignKey<BankExchangeTransactionRecord, BankRecord> BANK_EXCHANGE_TRANSACTION_IBFK_2 = Internal.createForeignKey(BankExchangeTransaction.BANK_EXCHANGE_TRANSACTION, DSL.name("bank_exchange_transaction_ibfk_2"), new TableField[] { BankExchangeTransaction.BANK_EXCHANGE_TRANSACTION.BANK_ID }, Keys.KEY_BANK_PRIMARY, new TableField[] { Bank.BANK.ID }, true);
    ...
    public static final ForeignKey<StockTransactionRecord, StockRecord> STOCK_TRANSACTION_IBFK_1 = Internal.createForeignKey(StockTransaction.STOCK_TRANSACTION, DSL.name("stock_transaction_ibfk_1"), new TableField[] { StockTransaction.STOCK_TRANSACTION.STOCK_ID }, Keys.KEY_STOCK_PRIMARY, new TableField[] { Stock.STOCK.ID }, true);
    public static final ForeignKey<StockTransactionRecord, UserRecord> STOCK_TRANSACTION_IBFK_2 = Internal.createForeignKey(StockTransaction.STOCK_TRANSACTION, DSL.name("stock_transaction_ibfk_2"), new TableField[] { StockTransaction.STOCK_TRANSACTION.USER_ID }, Keys.KEY_USER_PRIMARY, new TableField[] { User.USER.ID }, true);
    public static final ForeignKey<StockTransactionRecord, StockPriceRecord> STOCK_TRANSACTION_IBFK_3 = Internal.createForeignKey(StockTransaction.STOCK_TRANSACTION, DSL.name("stock_transaction_ibfk_3"), new TableField[] { StockTransaction.STOCK_TRANSACTION.STOCK_PRICE_ID }, Keys.KEY_STOCK_PRICE_PRIMARY, new TableField[] { StockPrice.STOCK_PRICE.ID }, true);
}
